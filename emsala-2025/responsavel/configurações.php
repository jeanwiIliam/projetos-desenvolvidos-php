...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($novaSenha) || empty($confirmarSenha)) {
        ...
        $query = "UPDATE responsavel SET RES_cod = ? WHERE RES_id = ?";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("si", $novaSenha, $responsavelID);
        if ($stmt->execute()) {
...
<head>
    ...
    <title>Configurações - Responsável</title>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar_nav">
            <ul class="sidebar_nav_links">
                ...
                <a href="configurações.php"><li class="side_active">Configurações</li></a>
