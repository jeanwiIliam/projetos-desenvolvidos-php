        ...
        <div class="container">
            <div class="container-vagas">
                ...
                <div class="linha-vagas">
                    <div class="vagas"><a href="../enviar-curriculo.php?d=m&e=glo&v=dew">Design web</a>  </div> <div class="qtd-vagas" >3</div>
                </div>
                <div class="linha-vagas">
                    <div class="vagas"><a href="../enviar-curriculo.php?d=m&e=glo&v=ans">Analista de sistemas</a> </div> <div class="qtd-vagas" >6</div>
                </div>
                <div  class="linha-vagas">
                    <div class="vagas"><a href="../enviar-curriculo.php?d=m&e=glo&v=prw">Programador web</a> </div> <div class="qtd-vagas" >9</div> 
                </div>
                <div class="linha-vagas">
                    <div class="vagas"><a href="../enviar-curriculo.php?d=m&e=glo&v=ate">Atendente</a> </div> <div class="qtd-vagas" >3</div>
                </div> 
            </div>
        </div>
