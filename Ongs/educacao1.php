...
<head>
    ...
    <title>Instituto Cinza das Rosas</title>
...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Instituto Cinza das Rosas</h1>
                <div></div>
                <p>Uma ONG voltada a educação de adolescentes a partir dos 14 anos até aos 18 anos, sendo educados conforme uma escola, esses adolescentes estão para adoção vindos de abrigos. </h3>
            </div>
