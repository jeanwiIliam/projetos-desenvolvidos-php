...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Abraço Apertado</h1>
                <div></div>
                <p>Não são os bens materiais que possuimos que representam riqueza, saúde e felicidade, são os momentos especiais que não tem preço, as pessoas uq estão próximas da gente e nos amam, a saúde, os amigos e felicidade.</h3>
            </div>
