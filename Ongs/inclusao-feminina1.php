...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Aurora Abrangente</h1>
                <div></div>
                <p>O projeto Aurora Abrangente consiste em ajudar crianças do sexo feminino que viem em situações de abandono, que foram abusadas e precisam de apoio psicológico e financeiro.</h3>
            </div>
