...
<head>
    ...
    <title>Instituto Folha Amarela</title>
...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Instituto Folha Amarela</h1>
                <div></div>
                <p>Nós da Folha Amarela estamos aqui para lutar contra os danos causados ao meio ambiente, fazendo campanhas contra a poluição ambiental e criando palestras em institutos educacionais para ensinar as crianças e adolescentes a cuidar do meio ambiente.</h3>
            </div>
