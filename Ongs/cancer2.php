...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Mural Rosa</h1>
                <div></div>
                <p>No mundo muitas pessoas ainda não sabem que possuem câncer, muitas vezes por não possuírem uma boa condição financeira de fazer exames ou por não ligarem muito, nós da Mural Rosa estamos aqui para ajudar por meio de doações a consulta com um médico especializado.</h3>
            </div>
