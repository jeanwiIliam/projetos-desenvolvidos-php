...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Bom Amigo</h1>
                <div></div>
                <p>A instituição promove doações de cachorros que são resgatados em situações precárias. A nossa ONG ajuda também a conscientizr as pessoas a respeito dos cuidados necessáros que você precisa ter com seu cachorro.</h3>
            </div>
