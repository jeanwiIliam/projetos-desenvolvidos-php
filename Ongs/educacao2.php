...
<head>
    ...
    <title>Aprendizagem Radiante</title>
...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Aprendizagem Radiante</h1>
                <div></div>
                <p>ONG voltada a educação de crianças com idade de 5 a 13 anos, utilizando métodos de ensino iguais das escolas, com eventos, brincadeiras, dinâmicas. As crianças que frequentam também são de abrigos.</h3>
            </div>
