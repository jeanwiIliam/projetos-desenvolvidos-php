...
<head>
    ...
    <title>Sinfonia de Aprendizado</title>
...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Sinfonia de Aprendizado</h1>
                <div></div>
                <p>A Sinfonia de Aprendizado foi criada no ano de 2021, buscamos ajudar pessoas de lugares remotos para que a educação não falte para essas pessoas.</h3>
            </div>
