...
<head>
    ...
    <title>Protetores dos Pets</title>
...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Protetores dos Pets</h1>
                <div></div>
                <p>Distribuimos rações para pets e realizamos campanhas de banho e tosa gratuitos. Distribuição de cartazes com informações sobre os cuidados de pets também é uma das coisas que é feita ela ONG.</h3>
            </div>
