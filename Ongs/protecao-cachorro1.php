...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Grande Amigo</h1>
                <div></div>
                <p>Durante toda sua vida você terá muitos amigos, trabalhos e filhos, mas para seu cachorro só existirá você enqunato ele viver.</h3>
            </div>
