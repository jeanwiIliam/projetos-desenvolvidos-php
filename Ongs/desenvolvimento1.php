...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Fundação Éter</h1>
                <div></div>
                <p>A Fundação Eter foi fundada em 2022, visamos ajudar crianças que não tem condições para ir a escola.</h3>
            </div>
