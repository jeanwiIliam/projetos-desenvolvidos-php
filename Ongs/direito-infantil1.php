...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Happy Happy</h1>
                <div></div>
                <p>Em todo o mundo ceca de 168 milhões de crianças são obrigaddas a trabalhar, sendo que 85 milhões delas estão envolvidas em trabalhos considerados perigosos, e nós da Happy Happy estamos aqui para acabar com isso e ir em busca dos direitos infantis dessas crianças. </h3>
            </div>
