...
?>
        ...
        <div class="container">
            <div class="ong">
                <h1>Ong Três Folhas</h1>
                <div></div>
                <p>Desmatamento, poluição e as queimadas florestais tem se tornado um dos problemas mais comuns ultimamente e a nossa organização irá commbater esses problemas com as doações e atos caridosos para realizar eventos e palestras de incentivo.</h3>
            </div>
